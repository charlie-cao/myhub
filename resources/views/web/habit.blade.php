...
<div class="container box" >
    <h1>日更(习惯)
        <small id="addNew" class="btn btn-default text-right">增加习惯</small>
        <small id="setup" class="btn btn-default text-right">修改设置</small>
    </h1>
    <table class="table">
        <tr>
            <th>日期</th>
            ...
            <div class="modal-body">
                ...
                本演示说明:
                    ...
                    功能点
                        ...
                        短信提醒
                        Jquery对话框
                基于makedown方式记录，并使用laralel的block模块化这个对话框
                    </pre>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
